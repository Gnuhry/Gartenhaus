...
public class Edit_Plant extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((EditText) findViewById(R.id.edTminTemp)).setText(help[2]);
        ((EditText) findViewById(R.id.edTmaxTemp)).setText(help[3]);
        ((EditText) findViewById(R.id.edTminGroundHumid)).setText(help[4]);
        ((EditText) findViewById(R.id.edTmaxGroundHumid)).setText(help[5]);
        ((EditText) findViewById(R.id.edTminHumid)).setText(help[6]);
        ((EditText) findViewById(R.id.edTmaxHumid)).setText(help[7]);
